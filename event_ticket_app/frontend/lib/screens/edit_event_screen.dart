...
class _EditEventScreenState extends State<EditEventScreen> {
  ...
  void initState() {
    ...
    _totalTicketsController = TextEditingController(
      text: widget.event.totalTickets.toString(),
    );
    _selectedDate = widget.event.date;
    _uploadedImageUrl = widget.event.imageUrl; // Use existing image URL
  }
  ...
  void _handleUpdateEvent() async {
    if (_formKey.currentState!.validate()) {
      ...
      final success = await eventProvider.updateEvent(widget.event.id, updates);
      ...
      if (success && mounted) {
        ...
        Navigator.pop(context, true); // Return true to indicate update was made
      } else if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Image preview - show either new uploaded image or existing event image
                    if (_imageBytes != null)
                      ClipRRect(
                        borderRadius: BorderRadius.circular(8),
                        child: Image.memory(
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  helperText:
                      'Current: ${widget.event.totalTickets} (${widget.event.totalTickets - (widget.event.availableTickets ?? 0)} sold)',
                ),
                keyboardType: TextInputType.number,
                validator: (value) {
                  if (value == null || value.isEmpty) {
